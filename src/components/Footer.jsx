...
export default function Footer() {
  return (
    <>
      <footer className="bg-[#232027] space-y-9 md:space-y-0 px-10 py-10 grid place-items-center md:place-items-start grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 text-center md:text-left">
        <div className="">
        ...
        <div className="text-white capitalize space-y-5">
          <h3 className="text-md font-extrabold">features</h3>
        ...
        <div className="text-white capitalize space-y-5">
          <h3 className="text-md font-extrabold">reasures</h3>
          <ul className="space-y-2 text-sm text-gray-300">
            <li>blog</li>
            <li>developers</li>
            <li>support</li>
        ...
        <div className="text-white  capitalize space-y-5">
          <h3 className="text-md font-extrabold">company</h3>
          <ul className="space-y-2 text-sm text-gray-300">
            <li>about</li>
            <li>our team</li>
            <li>careers</li>
        ...
        <div className="flex justify-evenly gap-5">
          <img className="size-6" src="/images/icon-facebook.svg" alt="facebook" loading="lazy" />
          <img className="size-6" src="/images/icon-twitter.svg" alt="twitter" loading="lazy" />
          <img className="size-6" src="/images/icon-pinterest.svg" alt="pinterest" loading="lazy" />
          <img className="size-6" src="/images/icon-instagram.svg" alt="instagram" loading="lazy" />
        </div>
      </footer>
      <div className="text-center text-sm text-white bg-[rgba(52,49,61,0.9)] py-3">
        Challenge by <a className="text-[#26D0CB] hover:text-[#97e4e4]" href="https://www.frontendmentor.io?ref=challenge" target="_blank">Frontend Mentor</a>.
        Coded by <a className="text-[#26D0CB] hover:text-[#97e4e4]" href="https://www.facebook.com/AbdurRahim1996">Abdur Rahim</a>.
      </div>
    </>
  )
}
